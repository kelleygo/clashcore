...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/kelleygo/clashcore/constant.Version=$(VERSION)" \
		-X "github.com/kelleygo/clashcore/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
